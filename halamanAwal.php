...
<body>
    <img src="./asset/Unesa.png" class="rounded mx-auto m-5 d-block" style="width: 150px;">
    ...
    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
                <img src="./asset/1.jpg" class="d-block w-25 opacity-0">
    ...
    <a href="login.php">
        <div class="col text-center">
            <button class="btn btn-primary w-50 rounded-pill">Login</button>
        </div>
    </a>
