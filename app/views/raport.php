...
<body>
  <header class="border-bottom border-warning border-5" style="background-color: #7B1FA1;">
    ...
    <div class="d-flex justify-content-center align-items-center my-4">
      <div class="">
        <img src="./asset/.jpg" alt="..." class=" me-5 rounded-circle" width="100px">
      </div>
      <div class="">
        <h3 class="mb-0">Rizki Januar I.</h3>
        <p class="mb-0">20051397046</p>
        ...
        <div class="col-6">
          <a href="#" class=" text-decoration-none">
            <div class="fitur p-3  text-center rounded" style="background-color : rgba(255,255,255,0.4) ">
              <i class="" style="font-size : 100px; color:#FFC007;"></i>
            </div>
          </a>
        </div>
